...
import { indLens, rowLens, colLens, regLens } from '~core/lenses/board'
import { getAvailables, getSelected } from '~core/selectors/board'
import { getAutoSolve } from '~core/selectors/toggles'
import { getNumberSelected } from '~core/selectors/numberSelected'
